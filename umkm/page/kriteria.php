...
<div class="row">
	...
	<div class="col-md-8">
	    <div class="panel panel-info" style="border-color: #ffc107;">
	        <div class="panel-heading" style="background-image: linear-gradient( 135deg, #43CBFF 10%, #9708CC 100%);"><h3 class="text-center" style="color: white;">LIST KRITERIA</h3></div>
	        <div class="panel-body">
	                ...
	                <tbody>
	                    ...
	                    <?php if ($query = $connection->query("SELECT a.nama AS kriteria, b.nama AS beasiswa, a.kd_kriteria, a.sifat FROM kriteria a JOIN beasiswa b USING(kd_beasiswa)")): ?>
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                <div class="btn-group">
	                                    <a href="?page=kriteria&action=update&key=<?=$row['kd_kriteria']?>" class="btn btn-success btn-xs">Edit</a>
