    ...
    <div class="wrapper">
       ...
       <div class="container">
        ...
        <div class="panel panel-<?= ($update) ? "warning" : "info" ?>" style="border-color: #ffc107;">
            <div class="panel-heading"style="background-image: linear-gradient( 135deg, #43CBFF 10%, #9708CC 100%);"><h3 class="text-center" style="color: white;">Data Rekening</h3></div>
            <div class="panel-body">
                <form action="daftar.php" method="post" enctype="multipart/form-data">
                    
                                    
                                            <input type="hidden" name="nim" value="<?= ucfirst($_SESSION["nik"]) ?>" class="form-control" readonly="on">
                                   
                                     <div class="form-group">
                                        <label for="nim">No Rekening</label>
                                            <input type="text" name="no" class="form-control">
                                    </div>
                                     <div class="form-group">
                                        <label for="nim">Nama Pemilik Rekening</label>
                                            <input type="text" name="nama" class="form-control">
                                    </div>
                                     <div class="form-group">
                                        <label for="nim">Nama Bank</label>
                                            <input type="text" name="bank" class="form-control">
                                    </div>
                      
                    <button type="submit" name="simpan" class="btn btn-primary btn-block">DAFTAR</button>
